...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://AndriiZakharenko.github.io/react_movies-list-js/) and add it to the PR description.
